function SkeletonCard() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-slate-700 bg-gray-900 p-4 shadow-sm">
      ...
      <div className="relative flex w-full flex-col gap-4">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1 h-4 w-5/6 rounded bg-slate-700" />
          </div>
        </div>
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1">
            {Array.from({ length: 5 }).map((_, index) => (
              <div key={`skeleton-star-${index}`} className="h-4 w-4 rounded bg-slate-700" />
            ))}
          </div>
