      ...
      {visible && (
        ...
        >
          ...
          <button
            ...
            className="w-full sm:w-auto px-5 py-2 text-sm font-semibold rounded-token bg-[#10b981] text-white hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#10b981] focus-visible:ring-offset-2 focus-visible:ring-offset-bg transition-all shrink-0 shadow-sm"
          >
            Accept
          </button>
        </MotionDiv>
