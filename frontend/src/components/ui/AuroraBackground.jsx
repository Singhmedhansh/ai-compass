...
export default function AuroraBackground({ children, className = "" }) {
  return (
    <div className={`relative flex flex-col items-center justify-center bg-bg transition-bg overflow-hidden w-full h-full ${className}`}>
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0 mask-gradient-b">
        <div
          className={`
