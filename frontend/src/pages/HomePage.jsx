...
function HomePage() {
  ...
  return (
    <main>
      <section className="relative z-0 flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-indigo-950 via-slate-900 to-gray-950 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg text-slate-300 sm:text-xl">
            Explore the top tools for coding, writing, research, and productivity in one curated place.
          </p>
          <div className="mt-8">
            <Link to="/tools">
